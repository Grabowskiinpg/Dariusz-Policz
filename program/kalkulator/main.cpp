...
int main() {
    ...
    std::cout << "32.exponent" << std::endl;
    std::cout << "33.iloczyn skalarny" << std::endl;
    std::cout << "34.iloczyn wektorowy" << std::endl;
    std::cout << "35.zapamietaj" << std::endl;
    std::cout << "36.Dodawanie liczb zespolonych" << std::endl;
    std::cout << "37.Calka z wielomianu" << std::endl;
    std::cout << "38.Calka nieoznaczona z wielomianu" << std::endl;
    std::cout << "39.Mantysa" << std::endl;
    std::cout << "40.Dodawanie wektorow" << std::endl;
    std::cout << "41.Dlugosc wektora" << std::endl;
    std::cout << "42.Notacja naukowa" << std::endl;
    std::cout << "43.Potega 10" << std::endl;
    std::cout << "44.Symbol Newtona" << std::endl;
    do {
        int nrdzial;
